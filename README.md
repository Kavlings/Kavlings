...
- I'm currently working on a **Trading212 portfolio dashboard project**, rounding my knowledge and skills in full stack building from CSV/API to selecting the sleekest UI and chart to show the end user. Planning to mess with LLM implementation after.
